...
if name == 'book':
    read_from_amazon('../data/Books_5.json')
elif name == 'taobao':
    read_from_taobao('../data/UserBehavior.csv')
elif name == 'movielens':
    read_from_movielens('../data/ml-1m/ratings.csv')
elif name == 'ml-10m':
    read_from_movielens('../data/ml-10M100K/ratings.csv')
elif name == 'gowalla':
    read_from_gowalla('../data/Gowalla/Gowalla.txt')
